...
func TestGetValue(t *testing.T) {
	...
	t.Run("get session cookie", func(t *testing.T) {
		...
		cookie := "forest"
		viper.Set("session.cookie.name", "forest")
		cookieName = GetSessionCookie()
...
func TestGetSessionCookieMaxAge(t *testing.T) {
	if GetSessionCookieMaxAge() != 24*3600 {
		t.Fatalf("get session cookie max age fail")
	}
}
