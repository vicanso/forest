...
export const names = {
  ...
  httpRequestInterceptors: "httpRequestInterceptors",
};
...
export const routes: Router[] = [
  ...
  {
    path: "/http-request-interceptors",
    name: names.httpRequestInterceptors,
    component: () => import("../views/configurations/HTTPRequestInterceptors"),
  },
];
